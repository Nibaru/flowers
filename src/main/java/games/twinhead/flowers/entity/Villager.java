...
public class Villager {
    ...
    public static final VillagerProfession FLORIST = registerProfession("florist", RegistryKey.of(Registry.POINT_OF_INTEREST_TYPE.getKey(), new Identifier(Flowers.MOD_ID, "florist_poi")));

    @SuppressWarnings("deprecation")
    public static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type) {
        return Registry.register(Registry.VILLAGER_PROFESSION, new Identifier(Flowers.MOD_ID, name),
